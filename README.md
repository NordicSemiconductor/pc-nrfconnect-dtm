...
The Direct Test Mode app in nRF Connect for Desktop is an application for
performing RF PHY testing of Bluetooth® Low Energy devices with the
Bluetooth-specified Direct Test Mode. See the
