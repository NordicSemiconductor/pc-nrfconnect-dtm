...
| Date       | Description   |
|------------|---------------|
| December 2025 | - Updated the [Transmitter tab settings](./overview.md#transmitter-tab) section with transmit power range values.<br/>- Removed information about the prebuilt firmware for the nRF52 DK (nRF52833 DK) and nRF52840 DK from the [Supported devices](index.md#supported-devices) section. |
