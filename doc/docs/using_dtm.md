...
1. In the Direct Test Mode app:
    ...
    1. Optionally, select the [**Serial port**](https://docs.nordicsemi.com/bundle/nrf-connect-desktop/page/common_interface.html#options-for-the-selected-device) from the drop-down menu.<br/>The selection should match the port assigned in the Device Manager.
